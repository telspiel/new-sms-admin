      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          <Route element={<Layout />}>
            ...
            <Route path="/credit-notifications" element={<CreditNotifications />} />
            ...
            <Route path="/detailed-mis" element={<DetailedMis />} />
            <Route path="/summary-report" element={<SummaryReport />} />
            <Route path="/error-code-report" element={<ErrorCodeReport />} />
            <Route path="/download-report" element={<DownloadReport />} />
            <Route path="/dr-summary" element={<DRSummary />} />
            <Route path="/manage-connect" element={<ManageConnect />} />
            <Route path="/new-user-routing" element={<NewUserRouting />} />
            <Route path="/switch-gateway" element={<SwitchGateway />} />
            <Route path="/userwise-routing" element={<UserwiseRouting />} />
            <Route path="/smpp-session-management" element={<SmppManagement />} />
            <Route path="/operator-traffic" element={<OperatorTraffic />} />
            <Route path="/global-blacklist" element={<GlobalBlacklist />} />
            <Route path="/user-premium-routing" element={<UserPremiumRouting />} />
            <Route path="/appearance-branding" element={<AppearanceBranding />} />
          </Route>
        </Route>
